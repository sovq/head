...
module.exports = function(config,eventEmitter,lightswitchlogdb){
	...
	this.name = config.name;
	this.enabled;	
	this.lightswitchlog = lightswitchlogdb;
	...
	this.switchEventHandler=function(ooSwitch,ConnectionEventArgs,socket){
		...
		console.log(ConnectionEventArgs)
	...
	this.logdb=function(toggle, source){
		...
		this.lightswitchlog.insert({ date: dateFormat(now, "yyyy-mm-dd, HH:MM:ss"), toggle: toggle, origin: source }, function (err) { });
	}
